(function() {
    ...
    const verify = function() {
        ...
        base64StrToArrayBuffer(credIdStrFromStorage).then(function(credIdArray) {
                alert(credIdArray); // bad says undefined
                var options = {
                    /*The challenge is typically a random quantity generated by the server
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (buttonSetupWinHello) {
            var hideSetupWindowsHelloDialog = function() { showSetupWindowsHelloDialog(false) };
            hideSetupWindowsHelloDialog();
            buttonSetupWinHello.addEventListener('click', hideSetupWindowsHelloDialog);
        }
