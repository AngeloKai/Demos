(function () {
	...
	const createCredential = function () {
		try {
			...
			const attestationChallenge = new Uint8Array(stringToBytes('Four score and seven years ago'));
	...
	const verify = function () {
		...
		const challenge = new Uint8Array(stringToBytes('Our fathers brought forth on this continent, a new nation'));
